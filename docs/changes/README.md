...
| [CR-SAN-039](CR-SAN-039-docs-restructure.md) | **Docs restructure**: slim README + per-route×surface install guide (`docs/INSTALL.md`/`docs/install/`, install→init→manage→uninstall) + **AUR removed from README** + uninstall matrix | provisioning-lifecycle (0.3.0) | IN_PROGRESS | CR-SAN-036..038, CR-SAN-035 | — |
