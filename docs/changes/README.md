...
| [CR-SAN-029](CR-SAN-029-projects-listing-tombstoned.md) | **`projects --all`**: include tombstoned rows (permanent markers) in the 3-column listing; default output unchanged | pre-v0.2.0 | IN_PROGRESS | — | — |
