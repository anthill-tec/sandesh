...
| [CR-SAN-032](CR-SAN-032-pi-surface-catchup.md) | **Pi surface catch-up**: 9→12 tools (archive/unarchive/search), 6 inbox/fetch filter params, `sandesh` ≥0.2.0 session gate, Wave-6 error-string pins, promptSnippet/docs refresh, pkg 0.2.0 | Wave 8 | IN_PROGRESS | CR-SAN-031 | — |
