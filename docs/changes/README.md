...
| [CR-SAN-025](CR-SAN-025-mcp-surface-update.md) | **MCP surface**: `sandesh_archive`+`sandesh_unarchive` (9→11 tools; tombstone/grant/revoke NEVER exposed), `project_id` optional where derivable, docstrings/`instructions`/usage + stdio E2E cross-project scenario | Wave 6 | IN_PROGRESS | CR-SAN-024 | — |
