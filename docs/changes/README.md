...
| [CR-SAN-031](CR-SAN-031-pi-wake-followup.md) | **Pi wake hardening**: the wake call gains `deliverAs: "followUp"` (mid-turn mail was silently lost + hot-spin; PE11 source-verified) + throw-survival guard | Wave 8 | IN_PROGRESS | — | — |
